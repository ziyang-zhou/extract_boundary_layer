...
bl_path = '/scratch/m/moreaust/zzhou/Reference_DNS/extract_boundary_profile/read_boundary_layer/BL_line_prof/' #path to read and write the boundary layer profiles
mesh_path = '/scratch/m/moreaust/zzhou/Reference_DNS/extract_boundary_profile/' #path to the grid generated by pre-processing script
