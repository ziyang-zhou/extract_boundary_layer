...
bl_path = '/scratch/m/moreaust/zzhou/Reference_DNS/postprocessing/extract_boundary_profile/read_boundary_layer/BL_line_prof/10mm_150pts/' #path to read and write the boundary layer profiles
